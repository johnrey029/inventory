<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="EditProducts.aspx.cs" Inherits="ecci.inv.system.EditProducts" MasterPageFile="~/Administrator.Master"%>
            ...
            <h3 class="box-title">Edit Product</h3>
              ...
              <div class="box-body">
                ...
                <div class="form-group">
                  ...
                  <textarea typeof="text" class="form-control" id="description" name="description" placeholder="Enter 
                  description" aria-autocomplete="none">
