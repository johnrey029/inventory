<%@ Page Title="" Language="C#" MasterPageFile="~/production/Production.Master" AutoEventWireup="true" CodeBehind="request.aspx.cs" Inherits="ecci.inv.system.production.WebForm2" %>
...
<asp:Content ID="HS1" ContentPlaceHolderID="heading" runat="server">
     <script type="text/javascript">  
         ...
         $.ajax({  
             type: "POST",  
             dataType: "json",
             url: "WebService/RequestMaterials.asmx/GetProductRaw",
