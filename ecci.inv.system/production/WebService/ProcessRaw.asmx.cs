...
{
    /// <summary>
    /// Summary description for ProcessRaw
    /// </summary>
    ...
    public class ProcessRaw : System.Web.Services.WebService
    {
        ...
        public void GetProductRaw()
        {
            ...
            WHERE w.receivedate is not null and w.quantity>=0 and w.code=3
            ORDER BY w.id ASC");
            while (con._dr.Read())
            {
                //
        ...
        public int UpdateDispatch(int upid)
        {
            ...
            con.Cmd.Parameters.AddWithValue("@c", 1);
