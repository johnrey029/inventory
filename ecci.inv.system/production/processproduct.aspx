<%@ Page Title="" Language="C#" MasterPageFile="~/production/Production.Master" AutoEventWireup="true" CodeBehind="processproduct.aspx.cs" Inherits="ecci.inv.system.production.processproduct" %>
        ...
        <div class="box">
          ...
          <div class="box-body">
            <%--<table id="manageTable" class="table table-bordered table-striped" style=" width: 100%">
              ...
              <asp:Button ID="btnRequest" runat="server" Width="100%" Text="Start Production" CssClass="btn btn-success" OnClick="btnRequest_Click"
              />
          </div>
          <!-- /.box-body -->
        </div>
