<%@ Page Title="" Language="C#" MasterPageFile="~/warehouse/WareHouse.Master" AutoEventWireup="true" CodeBehind="rawmaterials.aspx.cs" Inherits="ecci.inv.system.warehouse.rawmaterials" %>
<asp:Content ID="TS1" ContentPlaceHolderID="title" runat="server">
    Warehouse-Raw Reports
</asp:Content>
                     ...
                     columns: [
                         {
                             'data': 'id', 'render': function (data, type, row) {
                                 return "<a  class='btn btn-primary btn-sm' onClick='ConfirmUpdate(" + data + ")'><i class='fa fa-truck'></i>  Release</a>";
                             },
                             orderable: false
                         },
                         { 'data': 'purchaseOrder' },
        ...
        <div class="modal-body">
            ...
            <div class="form-group">
                ...
                <asp:UpdatePanel ID="UpdatePanel1" runat="server" RenderMode="Inline">
                    <ContentTemplate>
                <asp:TextBox ID="qty" CssClass="form-control"  runat="server" placeholder="Input Quantity Receive" autocomplete="off" min="0" AutoPostBack="True"  OnTextChanged="qty_TextChanged" onkeydown = "return (!(event.keyCode>=65) && event.keyCode!=32);"></asp:TextBox>
            </ContentTemplate> 
                        <Triggers>
